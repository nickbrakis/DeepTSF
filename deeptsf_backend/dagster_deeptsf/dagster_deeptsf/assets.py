...
def start_pipeline_run(context):
    ...
    if none_checker(series_csv):
        download_online_file(client, series_csv, dst_dir='dataset-storage', bucket_name='dataset-storage')

    if none_checker(future_covs_csv):
        download_online_file(client, future_covs_csv, dst_dir='dataset-storage', bucket_name='dataset-storage')

    if none_checker(past_covs_csv):
        download_online_file(client, past_covs_csv, dst_dir='dataset-storage', bucket_name='dataset-storage')
